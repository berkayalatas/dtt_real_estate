...
import header_style from '../styles/New_Listing.module.css'
...
function housePage({ data }) {
  ...
  return (
    <div className={styles.container}>
      {/* <div className={header_style.go_back_container}>
        <span
          className={header_style.back_btn}
          onClick={() => {
            router.push("/");
          }}
        >
        ...
        <p className={header_style.overview_text}>Back to overview</p>
      </div> */}
              ...
              <div className={styles.top_card}>
                <div className={styles.header_and_icons}>
                  ...
                  <div className={styles.edit_and_delete}>
                    <span className={styles.edit_desktop} onClick={handleEdit}>
